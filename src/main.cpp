...
//     xxml::reader::XmlStreamLexer sl;
//     //sl << "<note>    <to>Tove</to>    <from>Jani</from>    <heading>Reminder</heading>    <body/></note>";
//     sl << "<note importance=\"high\" logged=\"true\">    <to>Tove</to>    <from>Jani</from>    <heading>Reminder</heading>    <body>Don\'t forget me this weekend!</body></note>";
